...
setup(
  ...
  download_url = 'https://github.com/gregoryneal/zalgo/blob/master/code/dist/zalgo_text-0.6.tar.gz',
  keywords = ['diacritic', 'filter', 'zalgo', 'he is coming', 'ahhh'], # arbitrary keywords
  classifiers = [],
)